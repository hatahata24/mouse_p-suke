...
------------------------------------------------------------*/
//----走行パルス関連----
#define PULSE_SEC_HALF		90/ONE_STEP //206				//半区画走行用パルス。2倍すると1区画分に 208
#define PULSE_ROT_R90 		158//152//158		//右90度回転用パルス数 145
#define	PULSE_ROT_L90 		158//152//158		//左90度回転用パルス数 145
#define PULSE_ROT_180 		304//316		//180度回転用パルス数 289
